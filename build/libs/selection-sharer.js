...
!function (a)
{
	...
	var b = function (b)
	{
		...
		}), this.sel = null, this.textSelection = "", this.htmlSelection = "", this.appId = a('meta[property="fb:app_id"]').attr("content") || a('meta[property="fb:app_id"]').attr("value"), this.url2share = a('meta[property="og:url"]').attr("content") || a('meta[property="og:url"]').attr("value") || window.location.href, this.getSelectionText = function (a)
		{
			...
			{
				for (var e = document.createElement("div"), f = 0, g = a.rangeCount; g > f; ++f)
				{
					e.appendChild(a.getRangeAt(f).cloneContents());
				}
		...
		}, this.showPopunder = function ()
		{
			...
			if (a.isCollapsed || b.length < 10 || !b.match(/ /))
			{
				return c.hidePopunder();
			}
			if (c.popunder.classList.contains("fixed"))
			{
				return c.popunder.style.bottom = 0, c.popunder.style.bottom;
			}
			var d = a.getRangeAt(0),
			    e = d.endContainer.parentNode;
			if (c.popunder.classList.contains("show"))
			{
				if (Math.ceil(c.popunder.getBoundingClientRect().top) == Math.ceil(e.getBoundingClientRect().bottom))
				{
					return;
				}
		...
		}, this.pushSiblings = function (a)
		{
			...
			{
				a.classList.add("selectionSharer"), a.classList.add("moveDown")
			}
		}, this.hidePopunder = function (a)
		{
			if (a = a || function () {}, "fixed" == c.popunder)
			{
				return c.popunder.style.bottom = "-50px", a();
			}
			c.popunder.classList.remove("show"), c.placeholder && c.placeholder.classList.remove("show");
			for (var b = document.getElementsByClassName("moveDown"); el = b[0];)
			{
		...
		{
			var b = `<div class="selectionSharer" id="selectionSharerPopover" style="position:absolute;">
				<div id="selectionSharerPopover-inner">
				<ul>
				<li><a class="action" href="" title="Share this selection on Linkedin" target="_blank"><i class="fa fa-linkedin" aria-hidden="true"></i></a></li>
				<li><a class="action tweet" href="" title="Share this selection on Twitter" target="_blank"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
				<li><a class="action facebook" href="" title="Share this selection on Facebook" target="_blank"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
				</ul>
				</div>  <div class="selectionSharerPopover-clip"><span class="selectionSharerPopover-arrow"></span></div></div>`,
